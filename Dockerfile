# Docker file for csv2json ChRIS plugin app
#
# Build with
#
#   docker build -t <name> .
...
#
#    docker build --build-arg http_proxy=http://192.168.13.14:3128 --build-arg UID=$UID -t local/pl-csv2json .
#
# To run an interactive shell inside this container, do:
#
#   docker run -ti --entrypoint /bin/bash local/pl-csv2json
#
